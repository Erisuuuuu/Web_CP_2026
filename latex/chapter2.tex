...
и заинтересованных в разговорной практике в групповом формате. В системе
выделяются три роли пользователей.
...
\label{tab:personas}
\begin{tabular}{|p{2.8cm}|p{4.8cm}|p{6cm}|}
\hline
...
повторную запись одного участника на ту же встречу. Счётчик занятых мест
вычисляется агрегатным запросом \texttt{COUNT(*)} к таблице
\texttt{registrations} по идентификатору встречи.
