...
\begin{center}
    ...
    Стальмахову Ивану Сергеевичу, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения для поиска собеседников и языковых клубов
для разговорной практики английского языка с личными кабинетами пользователей»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих программных продуктов по теме работы                              & 10                 & 03.04.2026    &                     \\ \hline
    Задача 1.2. Анализ программных инструментов разработки веб-приложений                            & 7                  & 06.04.2026    &                     \\ \hline
    Задача 1.3. Формулировка цели и задач работы                                                     & 8                  & 11.04.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 2. Проектирование веб-приложения}}                                                                          \\ \hline
    Задача 2.1. Анализ целевой аудитории                                                             & 5                  & 14.04.2026    &                     \\ \hline
    Задача 2.2. Описание функциональности приложения (диаграмма вариантов использования, user story) & 7                  & 18.04.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (ER-диаграмма, логическая и физическая схемы БД)        & 8                  & 23.04.2026    &                     \\ \hline
    Задача 2.4. Разработка макетов страниц (Wireframe)                                               & 5                  & 27.04.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 3. Разработка веб-приложения}}                                                                              \\ \hline
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц                   & 8                  & 01.05.2026    &                     \\ \hline
    Задача 3.2. Реализация аутентификации пользователей                                              & 7                  & 05.05.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для пользователей, карточек клубов и встреч (событий)      & 7                  & 09.05.2026    &                     \\ \hline
    Задача 3.4. Реализация системы поиска, фильтрации и записи на встречи                            & 12                 & 14.05.2026    &                     \\ \hline
    Задача 3.5. Разработка системы тем, интересов и уровней владения языком                         & 6                  & 18.05.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с кодом проекта                                             & 3                  & 21.05.2026    &                     \\ \hline
    Задача 4.2. Деплой приложения на хостинг                                                         & 4                  & 24.05.2026    &                     \\ \hline
...
{
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{@{} P{0.4\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}

    «31» марта 2026~г. &
    \centering \rule{3.5cm}{0.4pt} \par \footnotesize (подпись) &
    \hfill И.С. Стальмахов                                            \\
\end{tabularx}
}
